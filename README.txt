...
To set up this environment in linux, user can run the pip install commands in accompanying 'requirements.txt', some variations on this may be required for windows.
